...
class DisplayMenu {
    ...
    public static function categoryNavigation(){
        ...
        $parent_categories = Category::whereRaw('parent IS NULL')->where('publish','T')->orderBy('id','desc')->get();
    ...
    public static function subjectNavigation(){
        ...
        $parent_subjects = Subject::whereRaw('parent IS NULL')->where('publish','T')->orderBy('id','desc')->get();
